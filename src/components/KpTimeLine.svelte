<script>
    ...
    //Kp predictions are every 3 hours or 10800000ms, we want a small separation so we use 10740000
    $: width = ($takeOffTime && $landingTime) ? 100 * 10740000 / ($landingTime - $takeOffTime) : 10;
